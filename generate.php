...
function hacklog_dap_process_error_backtrace() {
	...
	flush();
	if($fatal)
		wp_die("<p>Fatal Error!Please put <strong>define('WP_DEBUG', false);</strong> to your <strong>wp-config.php</strong> and then visit this page again to see what happened.<br />Error Message generated by Hacklog <strong>Down As PDF</strong> plugin");
}
